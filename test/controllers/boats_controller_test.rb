...
class BoatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create boat" do
    assert_difference("Boat.count") do
      post boats_url, params: { boat: { captain: @boat.captain, name: @boat.name, size: @boat.size } }
    end
  ...
  test "should update boat" do
    patch boat_url(@boat), params: { boat: { captain: @boat.captain, name: @boat.name, size: @boat.size } }
